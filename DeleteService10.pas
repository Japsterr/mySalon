...
type
  TfrmDeleteService10 = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
...
var
  frmDeleteService10: TfrmDeleteService10;

implementation

uses data, ConfirmDeleteService10;

{$R *.dfm}

procedure TfrmDeleteService10.fill;
begin
...
procedure TfrmDeleteService10.Button1Click(Sender: TObject);
begin
  if find then
  begin
    display();
...
procedure TfrmDeleteService10.display;
begin
  lblName.Caption := 'Press the Delete button to delete this service';
  lblPrice.Caption := FloatToStr(DataModule2.tbServiceTenPrice.Value);
end;

function TfrmDeleteService10.find;
var num : Integer;
    service : String;
    found : Boolean;
...
procedure TfrmDeleteService10.FormCreate(Sender: TObject);
begin
  fill();
end;

procedure TfrmDeleteService10.clear;
begin
