...
var
  frmEditService5: TfrmEditService5;
...
procedure TfrmEditService5.btnEditClick(Sender: TObject);
begin
  editService();
  DataModule2.connect;
  close();
...
procedure TfrmEditService5.Button1Click(Sender: TObject);
begin
  if findService then
  begin
    open();
...
procedure TfrmEditService5.close;
begin
...
procedure TfrmEditService5.fill;
begin
...
procedure TfrmEditService5.open;
begin
...
procedure TfrmEditService5.display;
begin
  edtName.Text := DataModule2.tbServiceFiveNames.Value;
  edtPrice.Text := FloatToStr(DataModule2.tbServiceFivePrice.Value);
end;

procedure TfrmEditService5.editService;
begin
  DataModule2.tbServiceFive.Edit;
  DataModule2.tbServiceFiveNames.Value := edtName.Text;
  DataModule2.tbServiceFivePrice.Value := StrToFloat(edtPrice.Text);
  DataModule2.tbServiceFive.Post;
end;


function TfrmEditService5.findService;
var num : Integer;
    service : String;
    found : Boolean;
...
procedure TfrmEditService5.FormCreate(Sender: TObject);
begin
    fill();
end;
